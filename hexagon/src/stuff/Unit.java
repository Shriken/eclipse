...
public class Unit {
	...
	public Unit(String name, int pointTotal) {
		this(name);
	...
	//load unit from file
	public Unit(String name, String fn) {
		this(name);
		...
		try {
			...
			for (int i=0; i<numSkills; i++) {
				...
				skills.add(new Skill(skillName, modifier, difficulty));
			}
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public Unit clone() {
		Unit u = new Unit(name, characterPoints);
